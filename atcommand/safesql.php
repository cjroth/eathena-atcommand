...
/*************************************
 * string safesql ( array variables )
 *
 * Prepare a mysql query to be safely executed, preventing injection
 */

function safesql ( $query, $variables ) {

	$safesql =& new SafeSQL_MySQL;
	$query = $safesql->query( $query, $variables );
	return $query;
